...
public class DevServerJava9OrAboveTest {
  ...
  public void testGetJdkVersion_isValid() {
    Assertions.assertEquals(8, DevServer.getJdkMajorVersion("1.8"));
    Assertions.assertEquals(9, DevServer.getJdkMajorVersion("9"));
    Assertions.assertEquals(11, DevServer.getJdkMajorVersion("11"));
    Assertions.assertEquals(17, DevServer.getJdkMajorVersion("17"));
    Assertions.assertEquals(21, DevServer.getJdkMajorVersion("21"));

    // These would be accepted for Java 8, but should expect them to be in
    // `java.specification.version` syntax
    Assertions.assertEquals(8, DevServer.getJdkMajorVersion("1.8.0_181-google-v7"));
    Assertions.assertEquals(1, DevServer.getJdkMajorVersion("1.11"));
  }
